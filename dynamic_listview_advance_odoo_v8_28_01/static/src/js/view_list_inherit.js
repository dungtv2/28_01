...
//                    self.render_fields_show();
        ...
        render_fields_show: function () {
            ...
            if (this.fields_view.type == 'tree' && typeof(this.result) != 'undefined'){
                ...
                QWeb.add_template("/dynamic_listview_advance_odoo_v8_28_01/static/src/xml/my_control.xml");
...
openerp.dynamic_listview_advance_odoo_v8_28_01 = function(instance) {
